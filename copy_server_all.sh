...
ssh $NAME@srv503956.hstgr.cloud 'bash -s' < "cd /home/programfid/app && ./backup_deploy.sh"
...
ssh $NAME@srv503956.hstgr.cloud 'bash -s' < "cd /home/programfid/app && sudo chown -R programfid:programfid ./"
#Остановка сервиса
