...
scp -P 22 backup_deploy.sh $USER@srv503956.hstgr.cloud:/home/programfid/app
#запуск выложеного скрипта на сервере 
ssh $USER@srv503956.hstgr.cloud 'bash -s' < "cd /home/programfid/app && ./backup_deploy.sh"
...
scp -P 22 test_prog.sh $USER@srv503956.hstgr.cloud:/home/programfid/app
#переименование всех файлов на programfid
ssh $USER@srv503956.hstgr.cloud 'bash -s' < "cd /home/programfid/app && sudo chown -R programfid:programfid ./"
#Остановка сервиса
