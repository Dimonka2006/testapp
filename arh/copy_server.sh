...
ssh dus@srv503956.hstgr.cloud 'cd /home/programfid/app && ./backup_deploy.sh'
...
ssh dus@srv503956.hstgr.cloud 'cd /home/programfid/app && sudo chown -R programfid:programfid ./'
#Остановка сервиса
